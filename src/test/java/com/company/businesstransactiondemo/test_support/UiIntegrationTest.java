package com.company.businesstransactiondemo.test_support;

import com.company.businesstransactiondemo.BusinessTransactionDemoApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.businesstransactiondemo.screen")
@ContextConfiguration(classes = {BusinessTransactionDemoApplication.class, UiTestAssistConfiguration.class})
